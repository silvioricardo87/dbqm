...
| QA-DDL-006 | Dado um nome que nao existe / Quando `dbqm ddl nao_existe local -f json` / Entao exit 2, `not_found`, `Objeto 'nao_existe' nao encontrado.` | functional | all | tests/functional/test_ddl.py::test_an_unknown_object_is_not_found |
