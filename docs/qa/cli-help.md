...
| QA-HELP-021 | Given `dbqm --help` at the reference width / Then every command's summary appears whole, none cut by the shortening budget | unit | all | tests/cli/test_help_shape.py::test_no_command_summary_is_truncated |
