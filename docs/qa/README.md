...
| functional | a seeded SQLite file (`tests/functional/conftest.py`) | every engine-agnostic command end to end, plus the screens that execute (`tests/ui/test_functional_screens.py`) |
